...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("Not a valid line!");
		...
		else
		{
			...
			if (parentNode == null) // If the parent node wasn't found, there must have been something wrong in the data file. Throw an exception.
				throw new TreeException("Data problem");
		}
